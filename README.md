...
| _KnowYourPlaceApi.ArticlesApi_      | [**articleControllerFindByPhrase**](docs/ArticlesApi.md#articleControllerFindByPhrase)                            | **GET** /api/v1/articles                | Returns a list of articles containing phrase in the title, content, author or category. If the phrase is empty, returns all articles. |
