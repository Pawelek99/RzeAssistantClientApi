...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnowYourPlaceApi.CreateCommentDto();
  });
  ...
  describe('CreateCommentDto', function() {
    it('should create an instance of CreateCommentDto', function() {
      // uncomment below and update the code to test CreateCommentDto
      //var instane = new KnowYourPlaceApi.CreateCommentDto();
      //expect(instance).to.be.a(KnowYourPlaceApi.CreateCommentDto);
    });
